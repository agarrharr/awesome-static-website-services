...
- [Netlify-CMS](https://github.com/netlify/netlify-cms) - A single page CMS for any static sites in a Git repository.
...
- [Caret](https://caret.io) - Premium markdown editor for Mac, Windows and Linux.
